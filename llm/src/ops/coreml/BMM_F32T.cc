...
void load_BMM_F32T_coreml(BMM_F32T_coreml &op, std::string prefix) { read_to_array((prefix + "/alpha.bin").c_str(), &op.alpha, 1); }

BMM_F32T_coreml::BMM_F32T_coreml(float _alpha) { this->alpha = _alpha; }
