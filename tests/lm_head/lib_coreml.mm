...
MLMultiArray * float_to_MLMultiArray(const float* __restrict__ data, int m, int n, NSError * error) {
...
void static_matmul(const float* __restrict__ x, const float* __restrict__ y, const float* __restrict__ out, int m, int n, int k) {
    // create the backings
